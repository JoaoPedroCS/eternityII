...
// nessa versão, obejtivo é selecionar as tiles que serão comparadas, tipo, precisa de cor 2 pra dar match com a tile anterior, então se olhara apenas para tiles que tem cor 2, reduzindo o numero de tiles a verificar.
// para pequenos boards, isso não faz diferença, mas para grandes boards, isso reduzirá imensamente o numero de comparações.
